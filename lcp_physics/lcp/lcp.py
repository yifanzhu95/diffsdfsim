...
from ..physics.utils import Defaults
from .solvers import cvxpy
from .solvers import batch as pdipm_b
# from .solvers import spbatch as pdipm_spb
...
def LCPFunction(eps=1e-12, verbose=0, notImprovedLim=3,
                 max_iter=20, solver=Defaults.SOLVER,
                 check_Q_spd=True):
    ...
    def __init__(self,eps=1e-12, verbose=0, notImprovedLim=3,
        ...
        class LCPFunctionFn(Function):
            ...
            def backward(ctx, dl_dzhat):
                ...
                grads = (dQs, dps, dGs, dhs, dAs, dbs, dFs)
                return grads
        self.func = LCPFunctionFn
    def run(self, M, u, G, h, Je, b, F):
        vals = self.func.apply(M, u, G, h, Je, b, F)
        return vals, self.lams, self.nus
